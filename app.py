...
def landslide():
     return render_template("landslide.html") #to send context to html

@app.route("/index/history")
def history():
     return render_template("history.html") #to send context to html
...
def predict():
    ...
    if output>str(0.5):
        return render_template('prediction.html',pred='Reaserching...'.format(output))
